				...
				<div class="col-5">
					...
					<div class="table-responsive">
						...
						<table class="table table-striped table-">
							...
							<tr>
								<th>Surname:</th>
								<td><?= ucwords($_SESSION['surname']); ?></td>
							</tr>
							<tr>
								<th>Forenames:</th>
								<td><?= ucwords($_SESSION['forenames']); ?></td>
							</tr>
							<tr>
								<th>Phone:</th>
						...
						<form action="#" method="post" id="updateProfileForm">
							...
							<div class="row">
								<div class="mb-2 col-6">
									...
									<input type="tel" class="form-control border border-success" name="phone" id="phone" value="<?= $_SESSION['phone']; ?>" maxlength="10" minlenght="10" required>
									<script>
							...
							<div class="mt-3">
								<button type="submit" class="btn forestgreen btn-success btn-g px-5 updateProfileBtn">
